...
@SupportedAnnotationTypes({"me.ujjawal.learning_java.annotations.custom.BuilderProperty"})
...
public class BuilderProcessor extends AbstractProcessor {
    ...
    private synchronized PrintWriter logger() {
        if(null == pw) {
            try {
                pw = new PrintWriter(new FileWriter("/Users/zop5857/IdeaProjects/learning-java/annotation.log"));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
